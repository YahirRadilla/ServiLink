    ...
    return (
        ...
        <SafeAreaView className='flex-1 bg-primarybg-servilink gap-y-14'>
            ...
            <View className= 'items-center '>
                <View className="w-96 max-w-md flex-col items-center  z-0 bg-primarybg-servilink p-4 rounded-xl shadow-md shadow-white">
                    ...
                    <View className="w-full" > 
                        ...
                        <View className='flex-row justify-center gap-2 w-full items-center pt-4'>
                            ...
                            <Link className='text-links-servilink ' href="/login">Inicia sesión</Link>
                        </View>
                    </View>
